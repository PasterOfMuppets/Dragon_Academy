...
List<ButtonInfo> rowLowKeyboardButtons = [
  ButtonInfo('', null, Colors.brown.shade100, 'tbd'),
  ButtonInfo('', null, Colors.brown.shade100, 'tbd'),
  ButtonInfo('', Mdi.alphaZBox, Colors.brown.shade100, 'tbd'),
  ButtonInfo('', Mdi.alphaXBox, Colors.brown.shade100, 'tbd'),
  ButtonInfo('', Mdi.alphaXBox, Colors.brown.shade100, 'tbd'),
  ButtonInfo('', Mdi.alphaYBox, Colors.brown.shade100, 'tbd'),
  ButtonInfo('', Mdi.alphaBBox, Colors.brown.shade100, 'tbd'),
  ButtonInfo('', Mdi.alphaNBox, Colors.brown.shade100, 'tbd'),
  ButtonInfo('', Mdi.alphaMBox, Colors.brown.shade100, 'tbd'),
  ButtonInfo('', null, Colors.brown.shade100, 'tbd'),
  ButtonInfo('', null, Colors.brown.shade100, 'tbd'),
];
...
List<ButtonInfo> rowBottomKeyboardButtons = [
  ...
  ButtonInfo('', null, Colors.brown.shade100, 'tbd'),
  ButtonInfo(',', Icons.circle, Colors.brown.shade100, 'tbd'),
  ButtonInfo('.', Icons.star_sharp, Colors.brown.shade100, 'tbd'),
  ButtonInfo('!', Icons.favorite, Colors.brown.shade100, 'tbd'),
  ButtonInfo('?', FontAwesomeIcons.cube, Colors.brown.shade100, 'tbd'),
  ButtonInfo('', null, Colors.brown.shade100, 'tbd'),
  ButtonInfo('', null, Colors.brown.shade100, 'tbd'),
];
